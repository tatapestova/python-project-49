...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/root/python-project-49/.venv'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('hexlet-code-py3.8' == '') {
...
alias deactivate = source '/root/python-project-49/.venv/bin/deactivate.nu'
